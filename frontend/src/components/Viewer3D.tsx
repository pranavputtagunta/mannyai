...
export default function Viewer3D({
  ...
  return (
    <div style={{ width: "100%", height: "100%", cursor: lassoActive ? "crosshair" : "auto" }}>
      <Canvas shadows camera={{ position: [0, 2, 5], fov: 45 }}>
        ...
        <Suspense fallback={null}>
          ...
          <LassoSelector
            ...
            filterObject={(obj: any) => {
              ...
              return !name.includes("helper") && !name.includes("grid") && !name.includes("axis");
            }}
          />
        ...
        <OrbitControls makeDefault enabled={!lassoActive} enableDamping dampingFactor={0.05} />
      </Canvas>
    </div>
  );
}